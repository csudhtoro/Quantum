      ...
      <div className="my-10 flex flex-wrap justify-center gap-3 md:justify-between items-center ">
        {data?.map((item) => (
          <Link
            ...
            className="text-sm text-gray-900 w-full sm:w-[45%] md:w-[30%] lg:w-[15%] flex justify-center items-center gap-2 px-12 py-4 rounded-lg font-semibold hover:opacity-70 active:scale-105"
